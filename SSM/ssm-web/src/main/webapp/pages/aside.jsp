...
<div class="input-group">
    ...
    <button type="submit" name="search" id="search-btn" class="btn btn-flat"><i class="fa fa-search"></i>
		...
		<ul class="sidebar-menu">
			...
			<li id="admin-index"><a href="${pageContext.request.contextPath}/pages/main.jsp"><i class="fa fa-home"></i> <span>首页</span></a></li>
			<!-- 菜单 -->
			<li class="treeview">
				<a href="#">
				...
				<ul class="treeview-menu">
					...
					<li id="system-setting">
						<a href="${pageContext.request.contextPath}/permission/findAll.do">
							<i class="fa fa-lock"></i> 资源权限管理
						</a>
					</li>

					<li id="system-settingadmin-500">
			...
			<li class="treeview">
				<a href="#">
					<i class="fa fa-database"></i> <span>基础数据</span>
					<span class="pull-right-container">
									<i class="fa fa-angle-left pull-right"></i>
								</span>
				</a>
				<ul class="treeview-menu">
					...
					<li id="system-setting">
						<a href="${pageContext.request.contextPath}/product/findAll.do">
							<i class="fa fa-folder-open-o"></i> 产品管理
						</a>
					</li>

					<li id="system-setting">
						<a href="${pageContext.request.contextPath}/orders/findAll.do">
							<i class="fa fa-rmb"></i> 订单管理
						</a>
					</li>
				</ul>
			</li>
