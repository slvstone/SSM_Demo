	...
	<body class="hold-transition skin-purple sidebar-mini">
									...
									<tbody>
                                        <c:forEach items="${productList}" var="product">
                                            <tr>
                                                ...
                                                <td>${product.departureTime.toLocaleString()}</td>
                                                <td class="text-center">${product.productPrice}</td>
                                                <td>${product.productDesc }</td>
                                                <td class="text-center"><c:if test="${product.productStatus==1}">开启</c:if><c:if test="${product.productStatus==0}">关闭</c:if></td>
		...
		<script>
			...
			function deletebyIds(){
				...
				alert(ids);
				location.href='${pageContext.request.contextPath}/product/deletebyIds.do?'+ids
			}
