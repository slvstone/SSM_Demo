				...
				<div class="row data-type">
					...
					<div class="col-md-4 data">
						<div class="input-group date">
							...
							<input type="text" class="form-control pull-right"
								...
								value="${orders.orderTime.toLocaleString()}">
						</div>
					</div>
					...
					<div class="col-md-4 data">
						<div class="input-group date">
							...
							<input type="text" class="form-control pull-right"
								id="datepicker-a6" value="${orders.product.departureTime.toLocaleString()}"
								readonly="readonly">
						</div>
					</div>
				...
				<table id="dataList"
					...
					<tbody>
						<c:forEach var="traveller" items="${orders.travellers}">
							...
							<tr>
								<td>
									<c:if test="${traveller.travellerType == 0}">成人</c:if>
									<c:if test="${traveller.travellerType == 1}">儿童</c:if>
								</td>
								...
								<td><input type="text" size="15"
									<c:if test="${traveller.credentialsType == 0}">value="身份证"</c:if>
									<c:if test="${traveller.credentialsType == 1}">value="护照"</c:if>
									<c:if test="${traveller.credentialsType == 2}">value="军官证"</c:if>
									readonly="readonly"></td>
				...
				<div class="panel panel-default">
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data text">
								在线支付
							<c:if test="${orders.payType==0}">支付宝</c:if>
							<c:if test="${orders.payType==1}">微信</c:if>
							<c:if test="${orders.payType==2}">其它</c:if>
						</div>
